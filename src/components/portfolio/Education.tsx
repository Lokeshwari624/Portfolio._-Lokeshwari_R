...
const items = [
  {
    ...
    period: "Pursuing",
    note: "Focus: Full-Stack Development, Cybersecurity, Generative AI.",
  },
  {
    icon: School,
    title: "Higher Secondary (12th)",
    org: "School Education",
    period: "Completed",
    note: "Strong foundation in Mathematics & Computer Science.",
  },
  {
    icon: BookOpen,
    ...
    org: "School Education",
    period: "Completed",
    note: "Built early interest in tech, design, and communication.",
  },
];
